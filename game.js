...
const HORSECOUNT = 4;
var scoreBoard = [];
var speed = [1, 1, 1, 1]; // pre-set starting speed, requires aditional entry for 5th horse
var speedInterval = 0;
var randomSpeed = 0;
var interval = 0;
...
function move() {
    ...
    if (scoreBoard.length == HORSECOUNT) {
...
//resets horse position to original and clears variables
